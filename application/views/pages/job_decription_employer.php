...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="styles/job_description_employer.css" />
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <ul style="list-style-type:circle">
                                        <li>Complying with all company, local, state, and federal accounting and
                                            financial
                                            regulations.</li>
                                        <li>Compiling, analyzing, and reporting financial data.</li>
                                        <li>Creating periodic reports, such as balance sheets, profit & loss
                                            statements,
                                            etc.</li>
                                        <li>Presenting data to managers, investors, and other entities.</li>
                                        <li>Maintaining accurate financial records.</li>
                                        <li>Performing audits and resolving discrepancies.</li>
                                        <li>Computing taxes.</li>
                                        <li> Keeping informed about current legislation relating to finance and
                                            accounting.</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <ol>
                                        <li>B.Tech or M.Tech from a recognized institution.</li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row border-right-0">
                                <div class="col-md-10">
                                    <h4><strong>Wasim Akram</strong></h4>
                                    Age:23 | Gender: Male
                                </div>
                                <a href="view_applicant.html" class="col-md-1.5 btn btn-primary text-center pull-right view">View
                                    Applicant</a>
                            </div>
                            <div class="row">
                                <div class="col-md-10">
                                ...
                                <a href="" class="col-md-1.5 btn btn-primary text-center pull-right view">View
                                    Applicant</a>
                            </div>
                        </div>
                    </div>
